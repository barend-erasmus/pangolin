...
(async () => {
    ...
    const storageProviders: {} = {
        disk: new DiskStorageProvider(true, './my-file-disk-1.log'),
        horizontalParitioningStorageProvider: new HorizontalParitioningStorageProvider([
            new DiskStorageProvider(false, './my-file-horizontal-paritioning-1.log'),
            new DiskStorageProvider(false, './my-file-horizontal-paritioning-2.log'),
            new DiskStorageProvider(false, './my-file-horizontal-paritioning-3.log'),
            new DiskStorageProvider(false, './my-file-horizontal-paritioning-4.log'),
            new DiskStorageProvider(false, './my-file-horizontal-paritioning-5.log'),
            new DiskStorageProvider(false, './my-file-horizontal-paritioning-6.log'),
        ]),
        inMemory: new InMemoryStorageProvider(),
        inMemoryBuffer100: new InMemoryBufferStorageProvider(100, new DiskStorageProvider(false, './my-file-in-memory-100.log')),
        inMemoryBuffer1000: new InMemoryBufferStorageProvider(1000, new DiskStorageProvider(false, './my-file-in-memory-1000.log')),
        inMemoryBuffer2000: new InMemoryBufferStorageProvider(2000, new DiskStorageProvider(false, './my-file-in-memory-2000.log')),
        inMemoryBuffer50: new InMemoryBufferStorageProvider(50, new DiskStorageProvider(false, './my-file-in-memory-50.log')),
        inMemoryBuffer500: new InMemoryBufferStorageProvider(500, new DiskStorageProvider(false, './my-file-in-memory-500.log')),
    };
